...
class Validate
{
     ...
     * @return void
     */
    public static function extend(string $type, $callback = null)
    {
        if (is_array($type)) {
     ...
     * @return void
     */
    public static function setTypeMsg($type, string $msg = null)
    {
        if (is_array($type)) {
     ...
     * @return bool
     */
    public function allowIp(string $value, $rule): bool
    {
        return in_array($value, is_array($rule) ? $rule : explode(',', $rule));
    }
     ...
     * @return bool
     */
    public function denyIp(string $value, $rule): bool
    {
        return !in_array($value, is_array($rule) ? $rule : explode(',', $rule));
    }
