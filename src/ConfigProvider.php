        ...
        return [
            ...
            'publish' => [
                [
                    ...
                    'source' => __DIR__ . '/../publish/language/en/validate.php',  // 对应的配置文件路径
                    'destination' => $languagesPath . '/en/validate.php', // 复制为这个路径下的该文件
                ],
                [
                    'id' => 'zh_CN',
                    'description' => '验证器中文语言包', // 描述
                    // 建议默认配置放在 publish 文件夹中，文件命名和组件名称相同
                    'source' => __DIR__ . '/../publish/language/zh_CN/validate.php',  // 对应的配置文件路径
                    'destination' => $languagesPath . '/zh_CN/validate.php', // 复制为这个路径下的该文件
                ],
            ],
        ];
    }
